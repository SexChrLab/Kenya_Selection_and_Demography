...
dat = data.frame(Bins = empirical_new[,1], Counts=c(empirical_new[,2], model_1epoch_new[,2], model_2epoch_new[,2]), category = c(empirical_labels, oneepoch_labels, twoepoch_labels))
...
ggplot(data=dat, aes(x=Bins, y=Counts, fill=category)) + 
  ...
  labs(y="Counts", x="")
ggsave("c://Users/tuyen/Documents/postdoc_asu/projects/Kenya_Selection_and_Demography/Population_History/05_demographic_inference/plots/compare_empirical_model_20200904.png", width = 9, height = 5, units = "in")
